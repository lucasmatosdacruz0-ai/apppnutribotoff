...
export const ALL_ACHIEVEMENTS: Achievement[] = [
    // Registration
    {
        ...
        icon: (props) => React.createElement(UserIcon, props),
        goal: 1,
    ...
    // Streaks
    {
        ...
        icon: (props) => React.createElement(FireIcon, props),
        goal: 3,
        category: 'streak',
        xpReward: 100,
    },
    ...
    },
    {
        ...
        icon: (props) => React.createElement(TrophyIcon, props),
        goal: 14,
        category: 'streak',
        xpReward: 500,
    },
    // Weight Loss
    {
        ...
        icon: (props) => React.createElement(ScaleIcon, props),
        goal: 1,
        category: 'weight',
        xpReward: 75,
    },
    ...
    // Plan
    {
        ...
        icon: (props) => React.createElement(SparklesIcon, props),
        goal: 1,
        category: 'plan',
        xpReward: 50,
    },
    // Water
    {
        ...
        icon: (props) => React.createElement(WaterDropletsIcon, props),
        goal: 3,
        category: 'water',
        xpReward: 50,
    },
    ...
    },
    {
        ...
        icon: (props) => React.createElement(StarIcon, props),
        goal: 3,
        category: 'recipe',
        xpReward: 50,
    },
    ...
    // Consistency
    {
        ...
        icon: (props) => React.createElement(TargetIcon, props),
        goal: 1,
